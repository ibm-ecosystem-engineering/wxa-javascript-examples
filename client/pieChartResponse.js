 ...
 * to display.
 */
function pieChartResponseHandler(event, instance) {
  ...
  const ctx = element.querySelector("#pieChart").getContext("2d");
  createPieChart(ctx);
}

/**
 * This function will create the pie chart using Chart.js with modified data for Red, Blue, and Purple categories.
 */
...
export { pieChartResponseHandler };
